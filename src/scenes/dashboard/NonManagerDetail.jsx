...
function EventDetailModal({ open, eventData, onClose, onUpdate, user }) {
        ...
        {isEditing ? (
          ...
          NonManagerShiftForm
            shift={{
              ...
              positionStr: fullPosition?.title || 'N/A',         // Passing the full position object w just fullPosition
              employeeStr: fullEmployee?.name || 'Unassigned', 
