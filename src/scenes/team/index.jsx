...
// BELOW WORKS with object in position.
...
const Team = ( {user} ) => {
  ...
  const columns = [
    ...
    //   align: "left",
    //   renderCell: (params) => {
    //     return params.row.position?.title || "N/A";
    //   }
    // },
    {
      field: "positionTitle",
    ...
    <Box m="20px">
      ...
      >
        ...
        >
          ...
          <MenuItem onClick={handleEditPosition}>View/Edit Position</MenuItem>
        </Menu>
